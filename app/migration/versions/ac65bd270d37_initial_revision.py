...
Revision ID: ac65bd270d37
Revises: bfd90d8fdd21
Create Date: 2024-10-08 21:14:54.773638
...
revision: str = 'ac65bd270d37'
down_revision: Union[str, None] = 'bfd90d8fdd21'
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'users_roles', 'roles', ['role_id'], ['id'], onupdate='CASCADE', ondelete='CASCADE')
